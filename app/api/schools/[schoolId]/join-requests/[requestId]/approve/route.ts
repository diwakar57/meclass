/**
 * API Route: POST /api/schools/[schoolId]/join-requests/[requestId]/approve
 * Principal approves a student join request
 */
...
const log = createLogger('API /api/schools/[schoolId]/join-requests/[requestId]/approve');
...
export async function POST(
  ...
  try {
    ...
    const { joinRequest, membership } = await membershipService.approveJoinRequest(
      schoolId,
      requestId,
      auth.userId,
