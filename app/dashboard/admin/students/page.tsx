...
const log = createLogger('AdminStudentListPage');
...
export default function AdminStudentListPage() {
  ...
  const handleRowAction = useCallback((action: string, student: Student) => {
    switch (action) {
      ...
      case 'progress':
        ...
        break;
      case 'attendance':
        window.location.href = `/dashboard/admin/schools?id=${student.id || student.studentId}&tab=attendance`;
        break;
      case 'grades':
        window.location.href = `/dashboard/admin/analytics?studentId=${student.id || student.studentId}`;
        break;
      case 'contact':
        window.location.href = `/dashboard/admin/communications?studentId=${student.id || student.studentId}`;
        break;
      case 'edit':
        window.location.href = `/dashboard/admin/schools?edit=${student.id || student.studentId}`;
        break;
      ...
      case 'export':
        ...
        const csv = generateCSV(selectedStudents);
  ...
  return (
    <DashboardLayout role="admin" pageTitle="Student Management">
        ...
        <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
          <div>
            ...
            <p className="mt-1 text-gray-600">
              {totalCount} student{totalCount !== 1 ? 's' : ''} across all schools
            </p>
          </div>
