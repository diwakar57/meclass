  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          <h2 className="text-lg font-semibold">Scene Outline</h2>
          <p className="text-sm text-muted-foreground">
            {outlines.length} scene(s); you can edit, add, delete, or reorder
          </p>
        </div>
            ...
            <CardContent className="space-y-4">
              <div className="space-y-2">
                ...
                <Textarea
                  ...
                  placeholder="Briefly describe the goal and content of this scene"
                  rows={2}
                  disabled={isLoading}
                />
              </div>
      ...
      {outlines.length === 0 && (
        <Card className="p-8 text-center">
          <p className="text-muted-foreground mb-4">No scene outline yet</p>
          <Button variant="outline" onClick={addOutline} disabled={isLoading}>
            <Plus className="size-4 mr-1" />
            Add first scene
          </Button>
