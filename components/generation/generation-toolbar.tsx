      ...
      <Popover>
        <PopoverTrigger asChild>
          <button className={pillMuted}>
            ...
            <span>{languageOptions.find((l) => l.code === language)?.label || language}</span>
          </button>
        </PopoverTrigger>
        <PopoverContent align="start" className="w-64 p-3">
          <div className="text-xs font-medium text-muted-foreground mb-2">{t('toolbar.languageHint')}</div>
